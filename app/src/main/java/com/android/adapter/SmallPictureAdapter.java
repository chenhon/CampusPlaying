 ...
 * 活动详情页里面的活动照片
 */
public class SmallPictureAdapter extends RecyclerView.Adapter<SmallPictureAdapter.ViewHolder> {
    ...
    public SmallPictureAdapter(Activity parentActivity, List<com.android.model.Activity> recommendActivityList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.small_picture_listitem, parent, false);
