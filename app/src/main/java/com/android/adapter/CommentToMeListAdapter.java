...
import com.android.tool.CustomLinkMovementMethod;
import com.android.tool.CustomTextView;
...
public class CommentToMeListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.mAttachedContent.setMovementMethod(CustomLinkMovementMethod.getInstance());
        spannable.setSpan(new TextClick() {                         //点击名称跳转到用户主页
                              @Override
                              public void onClick(View widget) {
                                  super.onClick(widget);
                                  new PersonOnClickListenerImpl(mActivity, mComments.get(position).getAttachCreatorId()).onClick(widget);
                              }
                          }
        ...
        viewHolder.mAttachedContent.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        viewHolder.mRlPicture.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = null;
                switch (mComments.get(position).getAttachType()) {
    ...
    static class ViewHolder {
        ...
        CustomTextView mAttachedContent;
