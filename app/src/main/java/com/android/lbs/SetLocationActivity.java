...
import com.android.tool.util.AMapUtil;
import com.android.tool.util.PoiOverlay;
import com.android.tool.util.ToastUtil;
...
public class SetLocationActivity extends FragmentActivity implements
	...
	public void searchButton() {
		...
		if ("".equals(keyWord)) {
			ToastUtil.show(SetLocationActivity.this, "请输入搜索关键字");
			return;
		} else {
			doSearchQuery();
		}
	...
	public void nextButton() {
		if (query != null && poiSearch != null && poiResult != null) {
			if (poiResult.getPageCount() - 1 > currentPage) {
				...
				ToastUtil.show(SetLocationActivity.this,
						"对不起，没有搜索到相关数据！");
			}
		}
	}
	...
	/*	button.setOnClickListener(new View.OnClickListener() {
		...
		button.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.putExtra("latitude", String.valueOf(marker.getPosition().latitude));//纬度
				intent.putExtra("longitude", String.valueOf(marker.getPosition().longitude));//经度
				intent.putExtra("address", marker.getTitle());//字符串形式的地址
	...
	private void showSuggestCity(List<SuggestionCity> cities) {
		...
		ToastUtil.show(SetLocationActivity.this, infomation);
	...
	public void onTextChanged(CharSequence s, int start, int before, int count) {
		...
		if (!AMapUtil.IsEmptyOrNullString(newText)) {
		    ...
		    Inputtips inputTips = new Inputtips(SetLocationActivity.this, inputquery);
